...
for idx, fname in enumerate(images):
	...
	gradx = abs_sobel(img, orient='x', thresh=(25,255)) # 25
	grady = abs_sobel(img, orient='y', thresh=(10,255)) # 10
	
	c_binary = color_threshold(img, sthresh=(100,255), vthresh=(200,255)) 
	preprocessImage[((gradx == 1) & (grady == 1) | (c_binary == 1) )] = 255
	#vertices = np.array([[(150, img.shape[0]), (0.48*img.shape[1] ,0.60*img.shape[0]),(img.shape[1]* 0.54, 0.60*img.shape[0]), (img.shape[1]-100, img.shape[0])]],dtype=np.int32)
	...
	write_name = './warped_output/tracked_color'+str(idx)+'.jpg'
